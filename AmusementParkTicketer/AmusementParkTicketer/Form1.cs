namespace AmusementParkTicketer
{
    public partial class Form1 : Form
    {
        ...
        // Save Total Profit and Sales Throughout Day
        ...
        {
            double payment;
            if (double.TryParse(paymentTextBox.Text, out payment)) // Try To Parse User Payment to Double
            {
                if (payment - total >= 0)
                {
